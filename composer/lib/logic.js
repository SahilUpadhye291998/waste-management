...
function LoginCompany(loginCompany) {
  ...
  //return onBlockchainbusinessEmail + " " + onBlockchainbusinessPasswd+" "+userInputBusinessEmail+" "+userInputBusinessPasswd;
...
function LoginCustomer(loginCustomer) {
  ...
  var userInputBusinessEmail = loginCustomer.personEmail;
  var userInputBusinessPasswd = loginCustomer.personPasswd;

    console.log(onBlockchainbusinessEmail);
